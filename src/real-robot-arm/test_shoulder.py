...
# --- CONFIG ---
SERIAL_PORT = '/dev/tty.usbmodem21201' # <--- CHECK PORT

# --- CUSTOMIZE YOUR PHYSICS HERE ---
SHOULDER_MIN = 50   # Don't go below this (prevents stalling with heavy gripper)
SHOULDER_MAX = 150  # Don't go above this (prevents falling backward)
