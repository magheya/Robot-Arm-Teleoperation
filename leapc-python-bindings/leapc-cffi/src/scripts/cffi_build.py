...
extra_link_args = {
    ...
    "Darwin": ["-Wl,-rpath,@loader_path", "-Wl,-rpath,/Applications/Ultraleap Hand Tracking.app/Contents/LeapSDK/lib"],
}
...
ffibuilder.set_source(
    ...
    include_dirs=[_RESOURCE_DIRECTORY, "/Applications/Ultraleap Hand Tracking.app/Contents/LeapSDK/include"],
    library_dirs=[_RESOURCE_DIRECTORY, "/Applications/Ultraleap Hand Tracking.app/Contents/LeapSDK/lib"],
